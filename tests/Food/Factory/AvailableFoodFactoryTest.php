...
class AvailableFoodFactoryTest extends TestCase
{
    ...
    {
        $this->assertCount(88, $this->sut->listAvailableFoods(new FoodFilterInput()));
    }
    ...
    public static function foodTagDataProvider(): array
    {
        return [
            ...
            'vacsora' => ['tags' => ['vacsora'], 'expectedCount' => 5],
            'köret'   => ['tags' => ['köret'], 'expectedCount' => 2],
            'saláta'  => ['tags' => ['saláta'], 'expectedCount' => 7],
            'új'      => ['tags' => ['új'], 'expectedCount' => 8],
