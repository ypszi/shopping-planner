...
namespace PeterPecosz\ShoppingPlanner\Tests\Unit\Supermarket;
...
class SupermarketTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->supermarket = new Supermarket(
            ...
            measureConverter       : $this->measureConverter = $this->createMock(MeasureConverter::class),
    ...
    public function testToShoppingList(): void
    {
        ...
        $this->measureConverter
            ->expects(self::never())
            ->method('convert')
            ->willReturnCallback(fn(IngredientForFood $ingredient, IngredientForFood $addedIngredient) => $ingredient);
