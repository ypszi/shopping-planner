...
use PeterPecosz\ShoppingPlanner\Tests\Support\FoodStub;
use PeterPecosz\ShoppingPlanner\Tests\Support\IngredientForFoodStub;
...
class FoodsFactoryTest extends TestCase
{
    ...
    public function testCreate(): void
    {
        ...
        $expectedIngredient = IngredientForFoodStub::fake()->toObject();
        $ingredientCount    = 10;
        $expectedFood       = FoodStub::fake()->toObject();
    ...
    public function testCreateWithReference(): void
    {
        ...
        $ingredientCount     = 10;
        $expectedFood        = FoodStub::fake()->toObject();
        $expectedRefFood     = FoodStub::fake()->toObject();
