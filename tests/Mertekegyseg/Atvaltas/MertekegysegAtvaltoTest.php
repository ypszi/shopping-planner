...
class MertekegysegAtvaltoTest extends TestCase
{
    ...
    public static function mertekegysegDataProvider(): array
    {
        return [
            ...
            'bogre to ml'             => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::BOGRE),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::ML),
                250.0,
            ],
            'cl to dl'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::CL),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::DL),
                0.1,
            ],
            'cl to l'                 => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::CL),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::L),
                0.01,
            ],
            'cl to ml'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::CL),
            ...
            'csesze to ml'            => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::CSESZE),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::ML),
                250.0,
            ],
            'dl to l'                 => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::DL),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::L),
                0.1,
            ],
            'dl to cl'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::DL),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::CL),
                10.0,
            ],
            'dl to ml'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::DL),
            ...
            'l to cl'                 => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::L),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::CL),
                100.0,
            ],
            'l to dl'                 => [
            ...
            'ml to cl'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::ML),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::CL),
                0.1,
            ],
            'ml to dl'                => [
            ...
            'ek to dl'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::EK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::DL),
                0.15,
            ],
            'ek to kvk'               => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::EK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 3, measure: Measure::KVK),
                15.0 / 5.0,
            ],
            'ek to kk'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::EK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 3, measure: Measure::KK),
                15.0 / 5.0,
            ],
            'ek to l'                 => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::EK),
            ...
            'ek to mk'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::EK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::MK),
                15.0 / 2.0,
            ],
            'ek to tk'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::EK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 3, measure: Measure::TK),
                15.0 / 5.0,
            ],
            'kvk to ek'               => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KVK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::EK),
                5.0 / 15.0,
            ],
            'kvk to kk'               => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KVK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::KK),
                1.0,
            ],
            'kvk to l'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KVK),
            ...
            'kk to ek'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::EK),
                5.0 / 15.0,
            ],
            'kk to kvk'               => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::KVK),
                1.0,
            ],
            'kk to l'                 => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KK),
            ...
            'kk to tk'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::KK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::TK),
                1.0,
            ],
            'ml to ek'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::ML),
            ...
            'ml to csepp'             => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::ML),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 20, measure: Measure::CSEPP),
                20.0,
            ],
            'csepp to ml'             => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::CSEPP),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::ML),
                0.05,
            ],
            'mk to ek'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::MK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::EK),
                2.0 / 15.0,
            ],
            'mk to kvk'               => [
            ...
            'tk to dl'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::TK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0, measure: Measure::DL),
                0.05,
            ],
            'tk to ek'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::TK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0.3, measure: Measure::EK),
                5.0 / 15.0,
            ],
            'tk to kvk'               => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::TK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0.3, measure: Measure::KVK),
                1.0,
            ],
            'tk to kk'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::TK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0.3, measure: Measure::KK),
                1.0,
            ],
            'tk to l'                 => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::TK),
            ...
            'tk to mk'                => [
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 1, measure: Measure::TK),
                new IngredientForFood(name: 'Napraforgó olaj', category: 'Olaj', portion: 0.3, measure: Measure::MK),
                5.0 / 2.0,
            ],
